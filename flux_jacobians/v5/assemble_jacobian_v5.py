"""
=============================================================================
GLOBAL FLUX JACOBIAN ASSEMBLER — FINITE DIFFERENCE VERSION (v5)
...
Updates from v4:
 (11) _harten                     — Harten entropy fix: smooth |λ| near zero
                                    |λ|_H = (λ²+ε²)/2ε  if |λ| < ε,  else |λ|
 (12) absolute_normal_jacobian    — harten_eps parameter (default 0.0)
 ...
 (15) assemble_global_jacobian_fd — harten_eps exposed (default 0.0, backward-compatible)

Usage:
    python assemble_jacobian_v5.py --mesh 765960 --re 60 --mach 0.2
    python assemble_jacobian_v5.py --mesh 765960 --re 60 --mach 0.2 --viscous
    python assemble_jacobian_v5.py --mesh 765960 --re 60 --mach 0.2 --harten-eps 0.1
    python assemble_jacobian_v5.py --help
=============================================================================
"""
...
def parse_args():
    ...
    p.add_argument("--data-dir",  type=str,
                   default="../../data/flux_jacobian_assembly_v5",
                   help="Output directory")
    p.add_argument("--harten-eps", type=float, default=0.0,
               help="Harten entropy fix fraction (0=off, 0.05-0.15 for transonic)")
    return p.parse_args()
